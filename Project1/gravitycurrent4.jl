...
xl = Lx / 5 # MAKE BIGGER LOCK
#xl = Lx/3 #EVEN BIGGER LOCK
xl2 = Lx-xl # ADD LOCATION FOR SECOND LOCK
...
bᵢ(x, y, z) = (Δb / 2) * (1 + tanh((x - xl) / Lf))-(Δb / 2) * (1 + tanh((x - xl2) / Lf)) #NEW IC WITH TWO LOCKS WITH LOW BUOYANCY
