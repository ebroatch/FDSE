...
#CHANGE BUOYANCY TO POINT AT 45 DEGREES
model = NonhydrostaticModel(; grid,
            ...
            timestepper = :RungeKutta3, # Set the timestepping scheme, here 3rd order Runge-Kutta
               ...
               buoyancy = Buoyancy(model=BuoyancyTracer(),gravity_unit_vector=(-sind(45),0,-cosd(45))), # this tells the model that b will act as the buoyancy (and influence momentum) 
